...
class BookingDetailsModel {
  ...
  BookingDetailsModel({this.booking, this.product, this.receiver, this.driver});
  ...
  @override
  String toString() {
    return 'BookingDetailsModel{booking: $booking, product: $product, receiver: $receiver, driver: $driver}';
  }
}
...
class Product {
  ...
  @override
  String toString() {
    return 'Product{id: $id, productType: $productType, image: $image, instructions: $instructions, booking: $booking}';
  }
}
