...
class PartnerModel {
  ...
  //   @override
  // String toString() {
  //   return 'PartnerModel(id: $id, isPartnerAvailable: $isPartnerAvailable, isActive: $isActive, '
  //       'isDeleted: $isDeleted, dateDeleted: $dateDeleted, name: $name, description: $description, '
  //       'latitude: $latitude, longitude: $longitude, sector: $sector, dateCreated: $dateCreated, '
  //       'image: $image, openAt: $openAt, closeAt: $closeAt)';
  // }
