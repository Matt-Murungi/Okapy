...
WSGI_APPLICATION = "okapy.wsgi.application"

# channels
ASGI_APPLICATION = "okapy.routing.application"
...
default_from_email = f"Okapy <noreply{email_host}>"
...
cred = credentials.Certificate(os.path.join(BASE_DIR, "./okapy/user_app_cred.json"))
